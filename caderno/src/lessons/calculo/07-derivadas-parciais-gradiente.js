export const blocks = [
  { type: 'h1', text: 'Derivadas Parciais e Gradiente' },
  ...
  { type: 'p', text: 'Isso se chama derivada parcial em x. Depois você faz a mesma pergunta pra y. Você finge que a outra variável é uma constante e deriva normalmente, usando as regras que já conhece.' },
  ...
  { type: 'p', text: 'Você junta as derivadas parciais de todas as variáveis num vetor — o mesmo conceito de vetor que você viu na Álgebra Linear. Esse vetor — o gradiente — aponta na direção de maior subida da função naquele ponto.' },
  { type: 'p', text: 'Se o gradiente é `[4, 3]`, significa: mover 1 unidade em x sobe 4, mover 1 unidade em y sobe 3. A direção `[4, 3]` combinada é a mais íngreme. Andar na direção **oposta**, `[−4, −3]`, é a descida mais rápida — a ideia que a aula de Gradient Descent vai usar pra treinar modelos inteiros.' },
  { type: 'note', text: 'Resumo: gradiente = lista das derivadas parciais, uma por variável. Aponta pra onde a função sobe mais rápido. Com n variáveis, o gradiente tem n números — é um vetor de tamanho n.' },
  ...
  { type: 'formal', eq: '∂f/∂x  — derivada parcial de f em relação a x\n∂f/∂y  — derivada parcial de f em relação a y\n\n∇f(x, y)  =  [ ∂f/∂x,  ∂f/∂y ]', legend: [
    ...
    '`∇` — nabla, símbolo do gradiente (lê-se "grad f" ou "nabla f")',
