export const blocks = [
  ...
  { type: 'p', text: 'Você quer derivar `(x² + 1)⁵`. Se o expoente estivesse em volta de um x simples — tipo `x⁵` — você usaria a regra da potência (já vista) e ia embora: `5x⁴`.' },
  ...
  { type: 'p', text: '**Passo 2:** Derive o exterior, usando as regras que você já conhece. Trate o interior como se fosse uma variável única (chame de u se ajudar).' },
  ...
  { type: 'p', text: 'Usando a derivada do seno (vista na aula de Trigonometria: `d/dx[sin(x)] = cos(x)`) como derivada do exterior: `cos(...)`. Derivada do interior `3x`: é `3`.' },
  ...
  { type: 'p', text: 'Usando a derivada da exponencial natural (vista na próxima aula: `d/dx[eˣ] = eˣ`, ela mesma) como derivada do exterior: `e^(...)`. Derivada do interior: `2x`.' },
  { type: 'p', text: 'Multiplica: `e^(x²) × 2x`.' },
  { type: 'formula', text: "d/dx [e^(x²)]  =  2x·e^(x²)" },

  { type: 'note', text: 'Resumo: regra da cadeia = derive o exterior, multiplique pela derivada do interior. Com três camadas aninhadas, você multiplica três derivadas — e é exatamente essa ideia, aplicada repetidamente camada por camada, que dá o nome ao backpropagation mais adiante.' },
  { type: 'viz', id: 'cadeia' },
